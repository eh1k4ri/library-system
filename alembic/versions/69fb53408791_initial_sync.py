...
def upgrade() -> None:
    ...
    op.drop_constraint(
        op.f("book_status_enumerator_key"), "book_status", type_="unique"
    )
    op.create_index(
    ...
    op.drop_constraint(
        op.f("loan_status_enumerator_key"), "loan_status", type_="unique"
    )
    op.create_index(
    ...
    op.drop_constraint(
        op.f("user_status_enumerator_key"), "user_status", type_="unique"
    )
    op.create_index(
...
def downgrade() -> None:
    ...
    op.create_unique_constraint(
        op.f("user_status_enumerator_key"),
        "user_status",
        ["enumerator"],
        postgresql_nulls_not_distinct=False,
    )
    ...
    op.create_unique_constraint(
        op.f("loan_status_enumerator_key"),
        "loan_status",
        ["enumerator"],
        postgresql_nulls_not_distinct=False,
    )
    ...
    op.create_unique_constraint(
        op.f("book_status_enumerator_key"),
        "book_status",
        ["enumerator"],
        postgresql_nulls_not_distinct=False,
    )
